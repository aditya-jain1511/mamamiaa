  ...
  const getEggie = async () => {
    ...
    if (check) {
      ...
      const api = await fetch(
        `https://api.spoonacular.com/recipes/random?apiKey=642b89fe5cf64cb7b5da7a6c57b6eab4&number=10&tags=vegetarian`
      );
    ...
    >
      <div className="home">
        ...
        >
          {eggieDishes}
          <SplideSlide>
          <Link to={'/seemore/&number=10&tags=vegetarian/eggiepicks'}>
